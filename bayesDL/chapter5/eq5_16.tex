...
\begin{equation}
U = - ln \, p(Y | W, X)p(W) = \sum_{n = 1}^N (-\frac{1}{{\sigma_y}^2}\frac{1}{2}(y_n - f(x_n;W))^2) + \frac{1}{{\sigma_w}^2}\frac{1}{2}w^T w + c = \frac{1}{{\sigma_y}^2} E(W) + \frac{1}{{\sigma_w}^2} \Omega_{L2}(W) + c
\end{equation}
