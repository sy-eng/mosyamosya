...
\begin{equation}
\begin{split}
\sum_{{\bf z}_1, ..., {\bf z}_N} p({\bf Z} | {\bf X}, \theta^{old}) \sum_{n=1}^N \sum_{k=1}^{K} z_{mk} \, ln \, p({\bf x}_m | {\bf z}_m, \phi_{k}) = \sum_{n=1}^N \sum_{k=1}^{K} \sum_{{\bf z}_1, ..., {\bf z}_N} p({\bf z}_1, ..., {\bf z}_N | {\bf X}, \theta^{old}) z_{nk} \, ln \, p({\bf x}_n | {\bf z}_n, \phi_{k})\\
